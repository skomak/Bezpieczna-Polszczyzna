...
|estimation|szacunek/ki, oszacowanie|estymacja|
...
|investigation|dochodzenie, śledztwo|inwestygacja|
...
|mindset|nastawienie||
|mitigation (ryzyka)|minimalizacja, ograniczanie|mitygacja|
|mockup|makieta||
|multiplication (efekt)|zwielokrotnienie, pomnożenie|multiplikacja|
...
|persistence (cyberbezpieczeństwo, mechanizm)|przetrwanie|persystencja|
|persistence (IT, dane)|zachowanie, utrwalenie|persystencja|
|pipeline|potok||
|portable|przenośny||
|preview|podgląd||
...
|relay|przekaźnik (np. TOR czy wifi relay)||
|release|wydanie||
